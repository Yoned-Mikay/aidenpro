...
window.addEventListener("load", function () {
  ...
  if (favicon !== null) {
    setfav.value = favicon;
  }
});

function hidesettings() {
  if (
    window.event.srcElement.id !== "settings" &&
    window.event.srcElement.id !== "settingsbtn" &&
    window.event.srcElement.className !== "settitle" &&
    window.event.srcElement.className !== "settab"
  ) {
